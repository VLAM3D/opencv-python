...
def find_version_main(opencvrepopath):
    opencv_version = ""
    # dig out the version from OpenCV sources
    version_file_path = os.path.join(opencvrepopath,"modules/core/include/opencv2/core/version.hpp")
...
if __name__ == "__main__" :
    parser = argparse.ArgumentParser(description='Find the OpenCV version from version.hpp.')
    parser.add_argument('opencvrepopath', type=str, help='Full path of the OpenCV repo')
    
    args = parser.parse_args()

    find_version_main(args.opencvrepopath)
